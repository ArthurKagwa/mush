...
> **📖 Full Protocol Reference:** See [`mushpi/docs/reference/BLE_PROTOCOL.md`](mushpi/docs/reference/BLE_PROTOCOL.md) for complete BLE protocol documentation including override bits, data formats, and examples.
